package com.example.parentwithsubscription.features.socialmedia.activity.instagram;
...
public class InstagramMessageDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        instagramMessagesRecyclerView = findViewById(R.id.instagram_messages_recyclerview);

        // Set up RecyclerView with LinearLayoutManager
        instagramMessagesRecyclerView.setLayoutManager(new LinearLayoutManager(this));

        // Get the contact details passed from the main activity
        String userId = getIntent().getStringExtra("user_id");
        String instagramMessagesJson = getIntent().getStringExtra("instagram_messages_details");
...
//            holder.messageText.setText(message.getContent());
        ...
        public class InstagramMessageViewHolder extends RecyclerView.ViewHolder {
