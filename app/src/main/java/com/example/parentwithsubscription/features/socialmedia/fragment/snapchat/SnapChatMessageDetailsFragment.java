package com.example.parentwithsubscription.features.socialmedia.fragment.snapchat;
...
public class SnapChatMessageDetailsFragment extends Fragment {
    ...
    private String snapchatMessagesJson;

    public static SnapChatMessageDetailsFragment newInstance(String userId, String snapchatMessagesJson) {
        SnapChatMessageDetailsFragment fragment = new SnapChatMessageDetailsFragment();
        Bundle args = new Bundle();
        args.putString("user_id", userId);
        args.putString("snapchat_messages_details", snapchatMessagesJson);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.snapchat_message_details, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        snapchatMessagesRecyclerView = view.findViewById(R.id.snapchat_messages_recyclerview);
        snapchatMessagesRecyclerView.setLayoutManager(new LinearLayoutManager(getContext()));

        if (getArguments() != null) {
            userId = getArguments().getString("user_id");
            snapchatMessagesJson = getArguments().getString("snapchat_messages_details");
        }
    ...
    public static class SnapChatMessageDetailsAdapter extends RecyclerView.Adapter<SnapChatMessageDetailsAdapter.SnapChatMessageViewHolder> {
        ...
        private final List<InstagramMessageDetails> snapchatMessageDetailsList;
        ...
        public static class SnapChatMessageViewHolder extends RecyclerView.ViewHolder {
